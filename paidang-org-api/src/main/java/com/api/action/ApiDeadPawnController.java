...
//        deadPawnDetail.setRedeemOverRate(PaidangConst.REDEEM_OVERRATE.toString());//逾期滞纳利率
    ...
    @ApiMethod(isLogin = true)
    public Ret orgPublishAuction(@ApiParam(value = "典当表id",required = true) String pawnId,MobileInfo mobileInfo,
    ...
    @ApiMethod(isLogin = true)
    public Ret comfirmSelling(@ApiParam(value = "(绝)当品id",required = true) String goodsId,
    ...
    @ApiMethod(isLogin = true)
    public Ret confirmFetchBack(@ApiParam(value = "(绝)当品id",required = true) String goodsId,
